...
-  Testing Methodolgies: Main testing is usability testing. Beyond it, unit testing and integration testing is also used significantly
...
| Security        | Protection against attacks    | Number of security vulnerabilities detected |
